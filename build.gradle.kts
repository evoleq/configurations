...
version = Config.ProjectData.Configurations.version//+"-SNAPSHOT"
...
publishing {
    publications {
        create<MavenPublication>("EvoleqPublication"){
            artifactId = Config.ProjectData.Configurations.artifactId
            ...
            pom.withXml {
                ...
                root.appendNode("name", Config.ProjectData.Configurations.artifactId)
...
bintray {
    ...
    pkg (delegateClosureOf<BintrayExtension.PackageConfig>{
        ...
        version (delegateClosureOf<BintrayExtension.VersionConfig>{
            name = Config.ProjectData.Configurations.version
